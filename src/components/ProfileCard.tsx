...
const Card = ({image, name, role, linkedin, github, gmail}: CardProps) => {
  return (
    <div className="flex h-96 w-80, flex-col items-center bg-gray-200">
        <div className="flex h-32 w-74 justify-center rounded-t-2xl bg-blue-600">
            <img className="relative top-14 size-30 rounded-full outline-3 outline-blue-700" src="{image}" alt="{name}" />
        </div>
